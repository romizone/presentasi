...
export const STRATEGIST_SYSTEM_PROMPT = [
  ...
  "  },",
  '  "currentScene": "Economist-style flat infographic of the current problem, pictograms only, no text",',
  '  "targetScene": "Economist-style flat infographic of the target system, pictograms only, no text"',
  "}",
  "",
  "Rules:",
  "- Write like a McKinsey exhibit.",
  ...
  "- currentScene and targetScene: two sentences of a flat editorial infographic — pictograms, objects, composition. Never a photograph, never coordinates, never lettering in the picture.",
